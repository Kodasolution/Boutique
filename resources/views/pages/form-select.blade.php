                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Use data attribute <code>data-icon</code> to add icon name for each options. And use
                                    class
                                    <code>.select2-icons</code> to set icon with option.
                                </p>
                                <div class="form-group">
                                    <select data-placeholder="Select a state..." class="select2-icons form-control"
                                        id="select2-icons">
                                        <optgroup label="Services">
                                            <option value="wordpress2" data-icon="bx bxl-wordpress" selected>WordPress
                                            </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Unlike other dropdowns on this page, this one matches options only if the term appears in
                                    the
                                    beginning of the string as opposed to anywhere: This custom matcher uses a compatibility
                                    module that
                                    is only bundled in the full version of Select2. You also have the option of using a more
                                    complex
                                    matcher.</p>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="btn-toolbar" role="toolbar" aria-label="Programmatic control">
                                    <button class="js-programmatic-set-val btn btn-outline-primary btn-sm mr-1 mb-1">Set
                                        "California"</button>
                                    <button
                                        class="js-programmatic-open btn btn-outline-primary btn-sm mr-1 mb-1">Open</button>
                                    <button
                                        class="js-programmatic-close btn btn-outline-primary btn-sm mr-1 mb-1">Close</button>
                                    <button
                                        class="js-programmatic-init btn btn-outline-primary btn-sm mr-1 mb-1">Init</button>
                                    <button
                                        class="js-programmatic-destroy btn btn-outline-primary btn-sm mr-1 mb-1">Destroy</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p>For different sizes of select2, Use classes like <code>.select2-size-sm</code> &amp;
                                    <code>.select2-size-lg</code> for Large, small &amp; Extra Small Select respectively.
                                </p>
                            </div>
                            <div class="col-12">
                                <h6>Large</h6>
