                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title" id="myModalLabel1">Create Other Field</h3>
                                    ...
                                    <div class="modal-body">
                                        @include('admin.otherField.create')
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <button type="button" class="btn  block" data-toggle="modal"
                                                data-target="#default_edit_other{{ $item->id }}">
                                                <i class="bx bx-edit-alt"></i>
                                            </button>
                                            @include('admin.otherField.edit')
                                            <form action="{{ route('admin.other.delete', ['other' => $item->id]) }}"
